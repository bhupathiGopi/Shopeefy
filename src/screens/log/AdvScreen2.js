...
const AdvScreen2 = ({navigation}) => {
  return (
    <View style={{flex:1}}>
        <View>
            <Image source={{uri:'https://i.ibb.co/ZLcGC3x/Slider-one-Bg02-3.png'}}
            
            style={styles.image}/>
        </View>
        <View style={styles.v2}>
        <Text style={styles.text}>Exotic Products</Text>
        </View>
        <View>
            <Text style={styles.text2}>More than 1000 + Product brands available in our app</Text>
        </View>
